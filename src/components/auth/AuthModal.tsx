...
export default function AuthModal({
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative border-b border-neutral-200 p-4 text-center">
          <button
            onClick={onClose}
            aria-label="Close"
            className="absolute left-4 top-4 rounded-full p-1 hover:bg-neutral-100"
          >
            <X className="h-5 w-5" />
          </button>
        ...
        <div className="p-6">
          ...
          {!isConfigured && (
            <p className="mb-4 rounded-lg bg-amber-50 p-3 text-sm text-amber-800">
              Demo mode: Firebase isn&apos;t configured, so sign-in is disabled.
              Add your keys to <code>.env.local</code> to enable accounts.
            </p>
          )}
